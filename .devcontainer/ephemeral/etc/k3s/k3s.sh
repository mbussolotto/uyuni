...
source /workspaces/uyuni/.devcontainer/ephemeral/etc/util/functions.sh
...
function k3s-install() {
  ...
  then
    ...
    sudo bash /workspaces/uyuni/.devcontainer/etc/docker/docker.sh
  fi
  ...
  rm -rf /workspaces/uyuni/.kube
  mkdir -p /workspaces/uyuni/.kube
  sudo cp /etc/rancher/k3s/k3s.yaml /workspaces/uyuni/.kube/config
  sudo chmod 777 -R /workspaces/uyuni/.kube
  ...
  kubectl apply -f /workspaces/uyuni/.devcontainer/etc/k3s/dashboard-adminuser.yaml
  kubectl apply -f /workspaces/uyuni/.devcontainer/etc/k3s/dashboard-rolebind.yaml
